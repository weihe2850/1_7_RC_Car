...
(cl:defmethod cl:initialize-instance :after ((m <CloudCluster>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CloudCluster)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name in2ulv_msgs-msg:<CloudCluster> is deprecated: use in2ulv_msgs-msg:CloudCluster instead.")))
...
(cl:defmethod cloud-val ((m <CloudCluster>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader in2ulv_msgs-msg:cloud-val is deprecated.  Use in2ulv_msgs-msg:cloud instead.")
  (cloud m))

(cl:ensure-generic-function 'min_point-val :lambda-list '(m))
(cl:defmethod min_point-val ((m <CloudCluster>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader in2ulv_msgs-msg:min_point-val is deprecated.  Use in2ulv_msgs-msg:min_point instead.")
  (min_point m))

(cl:ensure-generic-function 'max_point-val :lambda-list '(m))
(cl:defmethod max_point-val ((m <CloudCluster>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader in2ulv_msgs-msg:max_point-val is deprecated.  Use in2ulv_msgs-msg:max_point instead.")
  (max_point m))

(cl:ensure-generic-function 'avg_point-val :lambda-list '(m))
(cl:defmethod avg_point-val ((m <CloudCluster>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader in2ulv_msgs-msg:avg_point-val is deprecated.  Use in2ulv_msgs-msg:avg_point instead.")
  (avg_point m))

(cl:ensure-generic-function 'centroid_point-val :lambda-list '(m))
(cl:defmethod centroid_point-val ((m <CloudCluster>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader in2ulv_msgs-msg:centroid_point-val is deprecated.  Use in2ulv_msgs-msg:centroid_point instead.")
  (centroid_point m))

(cl:ensure-generic-function 'estimated_angle-val :lambda-list '(m))
(cl:defmethod estimated_angle-val ((m <CloudCluster>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader in2ulv_msgs-msg:estimated_angle-val is deprecated.  Use in2ulv_msgs-msg:estimated_angle instead.")
  (estimated_angle m))
...
(cl:defmethod eigen_values-val ((m <CloudCluster>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader in2ulv_msgs-msg:eigen_values-val is deprecated.  Use in2ulv_msgs-msg:eigen_values instead.")
  (eigen_values m))

(cl:ensure-generic-function 'eigen_vectors-val :lambda-list '(m))
(cl:defmethod eigen_vectors-val ((m <CloudCluster>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader in2ulv_msgs-msg:eigen_vectors-val is deprecated.  Use in2ulv_msgs-msg:eigen_vectors instead.")
  (eigen_vectors m))

(cl:ensure-generic-function 'fpfh_descriptor-val :lambda-list '(m))
(cl:defmethod fpfh_descriptor-val ((m <CloudCluster>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader in2ulv_msgs-msg:fpfh_descriptor-val is deprecated.  Use in2ulv_msgs-msg:fpfh_descriptor instead.")
  (fpfh_descriptor m))

(cl:ensure-generic-function 'bounding_box-val :lambda-list '(m))
(cl:defmethod bounding_box-val ((m <CloudCluster>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader in2ulv_msgs-msg:bounding_box-val is deprecated.  Use in2ulv_msgs-msg:bounding_box instead.")
  (bounding_box m))
