...
;//! \htmlinclude HDMapBin.msg.html

(cl:defclass <HDMapBin> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass HDMapBin (<HDMapBin>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <HDMapBin>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'HDMapBin)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name in2ulv_msgs-msg:<HDMapBin> is deprecated: use in2ulv_msgs-msg:HDMapBin instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <HDMapBin>))
...
(cl:defmethod format_version-val ((m <HDMapBin>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader in2ulv_msgs-msg:format_version-val is deprecated.  Use in2ulv_msgs-msg:format_version instead.")
  (format_version m))

(cl:ensure-generic-function 'map_version-val :lambda-list '(m))
(cl:defmethod map_version-val ((m <HDMapBin>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader in2ulv_msgs-msg:map_version-val is deprecated.  Use in2ulv_msgs-msg:map_version instead.")
  (map_version m))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <HDMapBin>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader in2ulv_msgs-msg:data-val is deprecated.  Use in2ulv_msgs-msg:data instead.")
  (data m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <HDMapBin>) ostream)
  "Serializes a message object of type '<HDMapBin>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <HDMapBin>) istream)
  "Deserializes a message object of type '<HDMapBin>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<HDMapBin>)))
  "Returns string type for a message object of type '<HDMapBin>"
  "in2ulv_msgs/HDMapBin")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'HDMapBin)))
  "Returns string type for a message object of type 'HDMapBin"
  "in2ulv_msgs/HDMapBin")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<HDMapBin>)))
  "Returns md5sum for a message object of type '<HDMapBin>"
  "9d7c66d4c8e6e3f95a20131a6e37fe22")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'HDMapBin)))
  "Returns md5sum for a message object of type 'HDMapBin"
  "9d7c66d4c8e6e3f95a20131a6e37fe22")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<HDMapBin>)))
  "Returns full string definition for message of type '<HDMapBin>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'HDMapBin)))
  "Returns full string definition for message of type 'HDMapBin"
  (cl:format cl:nil "# This contains the lanelet map in binary format.~%~%# Timestamp and frame_id of the map~%Header header~%~%# version of map format. keep this as empty string if unnecessary~%string format_version~%~%# version of map version. keep this as empty string if unnecessary~%string map_version~%~%# binary data of lanelet2 map. This is meant to be filled using toBinMsg() in lanelet2_extension library~%int8[] data~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <HDMapBin>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <HDMapBin>))
