// Generated by gencpp from file in2ulv_msgs/CloudCluster.msg
// DO NOT EDIT!


#ifndef IN2ULV_MSGS_MESSAGE_CLOUDCLUSTER_H
#define IN2ULV_MSGS_MESSAGE_CLOUDCLUSTER_H
...
struct CloudCluster_
{
  ...
  typedef boost::shared_ptr< ::in2ulv_msgs::CloudCluster_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::in2ulv_msgs::CloudCluster_<ContainerAllocator> const> ConstPtr;

}; // struct CloudCluster_

typedef ::in2ulv_msgs::CloudCluster_<std::allocator<void> > CloudCluster;

typedef boost::shared_ptr< ::in2ulv_msgs::CloudCluster > CloudClusterPtr;
typedef boost::shared_ptr< ::in2ulv_msgs::CloudCluster const> CloudClusterConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::in2ulv_msgs::CloudCluster_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::in2ulv_msgs::CloudCluster_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::in2ulv_msgs::CloudCluster_<ContainerAllocator1> & lhs, const ::in2ulv_msgs::CloudCluster_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::in2ulv_msgs::CloudCluster_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::in2ulv_msgs::CloudCluster_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::in2ulv_msgs::CloudCluster_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::in2ulv_msgs::CloudCluster_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::in2ulv_msgs::CloudCluster_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::in2ulv_msgs::CloudCluster_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::in2ulv_msgs::CloudCluster_<ContainerAllocator> >
{
  ...
  static const char* value(const ::in2ulv_msgs::CloudCluster_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xee7b21b447ceefbaULL;
  static const uint64_t static_value2 = 0x70710356a4b6162bULL;
};

template<class ContainerAllocator>
struct DataType< ::in2ulv_msgs::CloudCluster_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::in2ulv_msgs::CloudCluster_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::in2ulv_msgs::CloudCluster_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::in2ulv_msgs::CloudCluster_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::in2ulv_msgs::CloudCluster_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // IN2ULV_MSGS_MESSAGE_CLOUDCLUSTER_H
