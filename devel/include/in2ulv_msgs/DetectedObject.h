// Generated by gencpp from file in2ulv_msgs/DetectedObject.msg
// DO NOT EDIT!


#ifndef IN2ULV_MSGS_MESSAGE_DETECTEDOBJECT_H
#define IN2ULV_MSGS_MESSAGE_DETECTEDOBJECT_H
...
struct DetectedObject_
{
  ...
  typedef boost::shared_ptr< ::in2ulv_msgs::DetectedObject_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::in2ulv_msgs::DetectedObject_<ContainerAllocator> const> ConstPtr;

}; // struct DetectedObject_

typedef ::in2ulv_msgs::DetectedObject_<std::allocator<void> > DetectedObject;

typedef boost::shared_ptr< ::in2ulv_msgs::DetectedObject > DetectedObjectPtr;
typedef boost::shared_ptr< ::in2ulv_msgs::DetectedObject const> DetectedObjectConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::in2ulv_msgs::DetectedObject_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::in2ulv_msgs::DetectedObject_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::in2ulv_msgs::DetectedObject_<ContainerAllocator1> & lhs, const ::in2ulv_msgs::DetectedObject_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::in2ulv_msgs::DetectedObject_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::in2ulv_msgs::DetectedObject_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::in2ulv_msgs::DetectedObject_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::in2ulv_msgs::DetectedObject_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::in2ulv_msgs::DetectedObject_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::in2ulv_msgs::DetectedObject_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::in2ulv_msgs::DetectedObject_<ContainerAllocator> >
{
  ...
  static const char* value(const ::in2ulv_msgs::DetectedObject_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x3dd3b39b0fe0d68fULL;
  static const uint64_t static_value2 = 0xdfd6e1f764955599ULL;
};

template<class ContainerAllocator>
struct DataType< ::in2ulv_msgs::DetectedObject_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::in2ulv_msgs::DetectedObject_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::in2ulv_msgs::DetectedObject_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::in2ulv_msgs::DetectedObject_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::in2ulv_msgs::DetectedObject_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // IN2ULV_MSGS_MESSAGE_DETECTEDOBJECT_H
