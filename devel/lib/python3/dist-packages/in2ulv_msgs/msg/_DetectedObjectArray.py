...
"""autogenerated by genpy from in2ulv_msgs/DetectedObjectArray.msg. Do not edit."""
import codecs
import sys
...
class DetectedObjectArray(genpy.Message):
  ...
  _type = "in2ulv_msgs/DetectedObjectArray"
...
"""
  ...
  _slot_types = ['std_msgs/Header','in2ulv_msgs/DetectedObject[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = in2ulv_msgs.msg.DetectedObject()
        _v25 = val1.header
        start = end
        end += 4
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v94.encoding = str[start:end].decode('utf-8', 'rosmsg')
        else:
