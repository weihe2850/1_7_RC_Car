...
"""autogenerated by genpy from in2ulv_msgs/CloudClusterArray.msg. Do not edit."""
import codecs
import sys
...
class CloudClusterArray(genpy.Message):
  ...
  _type = "in2ulv_msgs/CloudClusterArray"
...
float32 z"""
  ...
  _slot_types = ['std_msgs/Header','in2ulv_msgs/CloudCluster[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = in2ulv_msgs.msg.CloudCluster()
        _v37 = val1.header
        start = end
        end += 4
